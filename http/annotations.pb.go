...
// 	protoc        v7.35.1
// source: proto/onekit/http/annotations.proto
...
func (HttpMethod) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_onekit_http_annotations_proto_enumTypes[0].Descriptor()
}

func (HttpMethod) Type() protoreflect.EnumType {
	return &file_proto_onekit_http_annotations_proto_enumTypes[0]
}
...
func (HttpMethod) EnumDescriptor() ([]byte, []int) {
	return file_proto_onekit_http_annotations_proto_rawDescGZIP(), []int{0}
}
...
func (Int64Encoding) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_onekit_http_annotations_proto_enumTypes[1].Descriptor()
}

func (Int64Encoding) Type() protoreflect.EnumType {
	return &file_proto_onekit_http_annotations_proto_enumTypes[1]
}
...
func (Int64Encoding) EnumDescriptor() ([]byte, []int) {
	return file_proto_onekit_http_annotations_proto_rawDescGZIP(), []int{1}
}
...
func (EnumEncoding) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_onekit_http_annotations_proto_enumTypes[2].Descriptor()
}

func (EnumEncoding) Type() protoreflect.EnumType {
	return &file_proto_onekit_http_annotations_proto_enumTypes[2]
}
...
func (EnumEncoding) EnumDescriptor() ([]byte, []int) {
	return file_proto_onekit_http_annotations_proto_rawDescGZIP(), []int{2}
}
...
func (EmptyBehavior) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_onekit_http_annotations_proto_enumTypes[3].Descriptor()
}

func (EmptyBehavior) Type() protoreflect.EnumType {
	return &file_proto_onekit_http_annotations_proto_enumTypes[3]
}
...
func (EmptyBehavior) EnumDescriptor() ([]byte, []int) {
	return file_proto_onekit_http_annotations_proto_rawDescGZIP(), []int{3}
}
...
func (TimestampFormat) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_onekit_http_annotations_proto_enumTypes[4].Descriptor()
}

func (TimestampFormat) Type() protoreflect.EnumType {
	return &file_proto_onekit_http_annotations_proto_enumTypes[4]
}
...
func (TimestampFormat) EnumDescriptor() ([]byte, []int) {
	return file_proto_onekit_http_annotations_proto_rawDescGZIP(), []int{4}
}
...
func (BytesEncoding) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_onekit_http_annotations_proto_enumTypes[5].Descriptor()
}

func (BytesEncoding) Type() protoreflect.EnumType {
	return &file_proto_onekit_http_annotations_proto_enumTypes[5]
}
...
func (BytesEncoding) EnumDescriptor() ([]byte, []int) {
	return file_proto_onekit_http_annotations_proto_rawDescGZIP(), []int{5}
}
...
type HttpConfig struct {
	...
	Method HttpMethod `protobuf:"varint,2,opt,name=method,proto3,enum=onekit.http.HttpMethod" json:"method,omitempty"`
...
func (x *HttpConfig) Reset() {
	*x = HttpConfig{}
	mi := &file_proto_onekit_http_annotations_proto_msgTypes[0]
...
func (x *ServiceConfig) Reset() {
	*x = ServiceConfig{}
	mi := &file_proto_onekit_http_annotations_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *FieldExamples) Reset() {
	*x = FieldExamples{}
	mi := &file_proto_onekit_http_annotations_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *QueryConfig) Reset() {
	*x = QueryConfig{}
	mi := &file_proto_onekit_http_annotations_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
// Applied to a oneof definition via (onekit.http.oneof_config).
...
func (x *OneofConfig) Reset() {
	*x = OneofConfig{}
	mi := &file_proto_onekit_http_annotations_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var file_proto_onekit_http_annotations_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.MethodOptions)(nil),
		ExtensionType: (*HttpConfig)(nil),
		Field:         50003,
		Name:          "onekit.http.config",
		Tag:           "bytes,50003,opt,name=config",
		Filename:      "proto/onekit/http/annotations.proto",
	},
	{
		ExtendedType:  (*descriptorpb.ServiceOptions)(nil),
		ExtensionType: (*ServiceConfig)(nil),
		Field:         50004,
		Name:          "onekit.http.service_config",
	...
	},
	{
		...
		Field:         50007,
		Name:          "onekit.http.field_examples",
	...
	},
	{
		...
		Field:         50010,
		Name:          "onekit.http.int64_encoding",
		Tag:           "varint,50010,opt,name=int64_encoding,enum=onekit.http.Int64Encoding",
		Filename:      "proto/onekit/http/annotations.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		...
		Field:         50011,
		Name:          "onekit.http.enum_encoding",
		Tag:           "varint,50011,opt,name=enum_encoding,enum=onekit.http.EnumEncoding",
		Filename:      "proto/onekit/http/annotations.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
	...
	},
	{
		...
		Field:         50014,
		Name:          "onekit.http.empty_behavior",
		Tag:           "varint,50014,opt,name=empty_behavior,enum=onekit.http.EmptyBehavior",
		Filename:      "proto/onekit/http/annotations.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		...
		Field:         50015,
		Name:          "onekit.http.timestamp_format",
		Tag:           "varint,50015,opt,name=timestamp_format,enum=onekit.http.TimestampFormat",
		Filename:      "proto/onekit/http/annotations.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		...
		Field:         50016,
		Name:          "onekit.http.bytes_encoding",
		Tag:           "varint,50016,opt,name=bytes_encoding,enum=onekit.http.BytesEncoding",
		Filename:      "proto/onekit/http/annotations.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
	...
	},
	{
		...
		ExtensionType: (*string)(nil),
		Field:         50020,
		Name:          "onekit.http.flatten_prefix",
...
var (
	// optional onekit.http.HttpConfig config = 50003;
	E_Config = &file_proto_onekit_http_annotations_proto_extTypes[0]
)

// Extension fields to descriptorpb.ServiceOptions.
var (
	// optional onekit.http.ServiceConfig service_config = 50004;
	E_ServiceConfig = &file_proto_onekit_http_annotations_proto_extTypes[1]
)
...
var (
	...
	//
	// optional onekit.http.OneofConfig oneof_config = 50017;
	E_OneofConfig = &file_proto_onekit_http_annotations_proto_extTypes[2]
)
...
var (
	...
	//
	// optional onekit.http.FieldExamples field_examples = 50007;
	E_FieldExamples = &file_proto_onekit_http_annotations_proto_extTypes[3]
	// Query parameter configuration for a field
	//
	// optional onekit.http.QueryConfig query = 50008;
	E_Query = &file_proto_onekit_http_annotations_proto_extTypes[4]
	...
	E_Unwrap = &file_proto_onekit_http_annotations_proto_extTypes[5]
	...
	//
	// optional onekit.http.Int64Encoding int64_encoding = 50010;
	E_Int64Encoding = &file_proto_onekit_http_annotations_proto_extTypes[6]
	...
	//
	// optional onekit.http.EnumEncoding enum_encoding = 50011;
	E_EnumEncoding = &file_proto_onekit_http_annotations_proto_extTypes[7]
	...
	E_Nullable = &file_proto_onekit_http_annotations_proto_extTypes[8]
	...
	//
	// optional onekit.http.EmptyBehavior empty_behavior = 50014;
	E_EmptyBehavior = &file_proto_onekit_http_annotations_proto_extTypes[9]
	...
	//
	// optional onekit.http.TimestampFormat timestamp_format = 50015;
	E_TimestampFormat = &file_proto_onekit_http_annotations_proto_extTypes[10]
	// Controls bytes JSON encoding for this field.
	// Valid on: bytes fields only.
	// Default: BASE64 (protojson default).
	//
	// optional onekit.http.BytesEncoding bytes_encoding = 50016;
	E_BytesEncoding = &file_proto_onekit_http_annotations_proto_extTypes[11]
	...
	E_OneofValue = &file_proto_onekit_http_annotations_proto_extTypes[12]
	...
	E_Flatten = &file_proto_onekit_http_annotations_proto_extTypes[13]
	...
	E_FlattenPrefix = &file_proto_onekit_http_annotations_proto_extTypes[14]
)
...
var (
	...
	E_EnumValue = &file_proto_onekit_http_annotations_proto_extTypes[15]
)

var File_proto_onekit_http_annotations_proto protoreflect.FileDescriptor
...
const file_proto_onekit_http_annotations_proto_rawDesc = "" +
	...
	"\x12BYTES_ENCODING_HEX\x10\x05:Q\n" +
	"\x06config\x12\x1e.google.protobuf.MethodOptions\x18ӆ\x03 \x01(\v2\x17.onekit.http.HttpConfigR\x06config:d\n" +
	"\x0eservice_config\x12\x1f.google.protobuf.ServiceOptions\x18Ԇ\x03 \x01(\v2\x1a.onekit.http.ServiceConfigR\rserviceConfig:_\n" +
	"\foneof_config\x12\x1d.google.protobuf.OneofOptions\x18\xe1\x86\x03 \x01(\v2\x18.onekit.http.OneofConfigR\voneofConfig\x88\x01\x01:b\n" +
	"\x0efield_examples\x12\x1d.google.protobuf.FieldOptions\x18׆\x03 \x01(\v2\x1a.onekit.http.FieldExamplesR\rfieldExamples:O\n" +
	"\x05query\x12\x1d.google.protobuf.FieldOptions\x18؆\x03 \x01(\v2\x18.onekit.http.QueryConfigR\x05query:7\n" +
	"\x06unwrap\x12\x1d.google.protobuf.FieldOptions\x18ن\x03 \x01(\bR\x06unwrap:e\n" +
	"\x0eint64_encoding\x12\x1d.google.protobuf.FieldOptions\x18چ\x03 \x01(\x0e2\x1a.onekit.http.Int64EncodingR\rint64Encoding\x88\x01\x01:b\n" +
	"\renum_encoding\x12\x1d.google.protobuf.FieldOptions\x18ۆ\x03 \x01(\x0e2\x19.onekit.http.EnumEncodingR\fenumEncoding\x88\x01\x01:>\n" +
	"\bnullable\x12\x1d.google.protobuf.FieldOptions\x18݆\x03 \x01(\bR\bnullable\x88\x01\x01:e\n" +
	"\x0eempty_behavior\x12\x1d.google.protobuf.FieldOptions\x18ކ\x03 \x01(\x0e2\x1a.onekit.http.EmptyBehaviorR\remptyBehavior\x88\x01\x01:k\n" +
	"\x10timestamp_format\x12\x1d.google.protobuf.FieldOptions\x18߆\x03 \x01(\x0e2\x1c.onekit.http.TimestampFormatR\x0ftimestampFormat\x88\x01\x01:e\n" +
	"\x0ebytes_encoding\x12\x1d.google.protobuf.FieldOptions\x18\xe0\x86\x03 \x01(\x0e2\x1a.onekit.http.BytesEncodingR\rbytesEncoding\x88\x01\x01:C\n" +
...
var (
	...
	file_proto_onekit_http_annotations_proto_rawDescData []byte
)

func file_proto_onekit_http_annotations_proto_rawDescGZIP() []byte {
	file_proto_onekit_http_annotations_proto_rawDescOnce.Do(func() {
		file_proto_onekit_http_annotations_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_onekit_http_annotations_proto_rawDesc), len(file_proto_onekit_http_annotations_proto_rawDesc)))
	})
	return file_proto_onekit_http_annotations_proto_rawDescData
}

var file_proto_onekit_http_annotations_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_proto_onekit_http_annotations_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_onekit_http_annotations_proto_goTypes = []any{
	(HttpMethod)(0),                       // 0: onekit.http.HttpMethod
	(Int64Encoding)(0),                    // 1: onekit.http.Int64Encoding
	(EnumEncoding)(0),                     // 2: onekit.http.EnumEncoding
	(EmptyBehavior)(0),                    // 3: onekit.http.EmptyBehavior
	(TimestampFormat)(0),                  // 4: onekit.http.TimestampFormat
	(BytesEncoding)(0),                    // 5: onekit.http.BytesEncoding
	(*HttpConfig)(nil),                    // 6: onekit.http.HttpConfig
	(*ServiceConfig)(nil),                 // 7: onekit.http.ServiceConfig
	(*FieldExamples)(nil),                 // 8: onekit.http.FieldExamples
	(*QueryConfig)(nil),                   // 9: onekit.http.QueryConfig
	(*OneofConfig)(nil),                   // 10: onekit.http.OneofConfig
...
var file_proto_onekit_http_annotations_proto_depIdxs = []int32{
	0,  // 0: onekit.http.HttpConfig.method:type_name -> onekit.http.HttpMethod
	11, // 1: onekit.http.config:extendee -> google.protobuf.MethodOptions
	12, // 2: onekit.http.service_config:extendee -> google.protobuf.ServiceOptions
	13, // 3: onekit.http.oneof_config:extendee -> google.protobuf.OneofOptions
	14, // 4: onekit.http.field_examples:extendee -> google.protobuf.FieldOptions
	14, // 5: onekit.http.query:extendee -> google.protobuf.FieldOptions
	14, // 6: onekit.http.unwrap:extendee -> google.protobuf.FieldOptions
	14, // 7: onekit.http.int64_encoding:extendee -> google.protobuf.FieldOptions
	14, // 8: onekit.http.enum_encoding:extendee -> google.protobuf.FieldOptions
	14, // 9: onekit.http.nullable:extendee -> google.protobuf.FieldOptions
	14, // 10: onekit.http.empty_behavior:extendee -> google.protobuf.FieldOptions
	14, // 11: onekit.http.timestamp_format:extendee -> google.protobuf.FieldOptions
	14, // 12: onekit.http.bytes_encoding:extendee -> google.protobuf.FieldOptions
	14, // 13: onekit.http.oneof_value:extendee -> google.protobuf.FieldOptions
	14, // 14: onekit.http.flatten:extendee -> google.protobuf.FieldOptions
	14, // 15: onekit.http.flatten_prefix:extendee -> google.protobuf.FieldOptions
	15, // 16: onekit.http.enum_value:extendee -> google.protobuf.EnumValueOptions
	6,  // 17: onekit.http.config:type_name -> onekit.http.HttpConfig
	7,  // 18: onekit.http.service_config:type_name -> onekit.http.ServiceConfig
	10, // 19: onekit.http.oneof_config:type_name -> onekit.http.OneofConfig
	8,  // 20: onekit.http.field_examples:type_name -> onekit.http.FieldExamples
	9,  // 21: onekit.http.query:type_name -> onekit.http.QueryConfig
	1,  // 22: onekit.http.int64_encoding:type_name -> onekit.http.Int64Encoding
	2,  // 23: onekit.http.enum_encoding:type_name -> onekit.http.EnumEncoding
	3,  // 24: onekit.http.empty_behavior:type_name -> onekit.http.EmptyBehavior
	4,  // 25: onekit.http.timestamp_format:type_name -> onekit.http.TimestampFormat
	5,  // 26: onekit.http.bytes_encoding:type_name -> onekit.http.BytesEncoding
...
func init() { file_proto_onekit_http_annotations_proto_init() }
func file_proto_onekit_http_annotations_proto_init() {
	if File_proto_onekit_http_annotations_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_onekit_http_annotations_proto_rawDesc), len(file_proto_onekit_http_annotations_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   5,
			NumExtensions: 16,
			NumServices:   0,
		},
		GoTypes:           file_proto_onekit_http_annotations_proto_goTypes,
		DependencyIndexes: file_proto_onekit_http_annotations_proto_depIdxs,
		EnumInfos:         file_proto_onekit_http_annotations_proto_enumTypes,
		MessageInfos:      file_proto_onekit_http_annotations_proto_msgTypes,
		ExtensionInfos:    file_proto_onekit_http_annotations_proto_extTypes,
	}.Build()
	File_proto_onekit_http_annotations_proto = out.File
	file_proto_onekit_http_annotations_proto_goTypes = nil
	file_proto_onekit_http_annotations_proto_depIdxs = nil
}
